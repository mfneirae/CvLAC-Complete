...
REPLACE INTO `uapa_db`.`v_colciencias_tipo_evento` ( `cod_tipo_evento`,`tipo_evento_col`,`tipo_evento_uapa`,`tipo_pregrado`,`tipo_posgrado`) VALUES (4,'Encuentro','Encuentro',null,null);
REPLACE INTO `uapa_db`.`v_colciencias_tipo_evento` ( `cod_tipo_evento`,`tipo_evento_col`,`tipo_evento_uapa`,`tipo_pregrado`,`tipo_posgrado`) VALUES (5,'Seminario','Seminario',null,null);
REPLACE INTO `uapa_db`.`v_colciencias_tipo_evento` ( `cod_tipo_evento`,`tipo_evento_col`,`tipo_evento_uapa`,`tipo_pregrado`,`tipo_posgrado`) VALUES (6,'Simposio','Simposio',null,null);
