...
def reconocimientosextract():
    ...
    if all != 0:
        ...
        for x in range(0, len(container)):
            ...
            + re.sub(r'[^\x00-\x7f]',r'',re.sub(' +',' ',Mes.strip().replace('"',"").replace("'","").replace(";" , "|").replace("\r\n","").replace("\n","").replace("\r",""))) + ";" \
            + re.sub(r'[^\x00-\x7f]',r'',re.sub(' +',' ',Ano.strip().replace('"',"").replace("'","").replace(";" , "|").replace("\r\n","").replace("\n","").replace("\r",""))) + ";" \
            + re.sub(r'[^\x00-\x7f]',r'',re.sub(' +',' ',Institucion.strip().replace('"',"").replace("'","").replace(";" , "|").replace("\r\n","").replace("\n","").replace("\r",""))) + ";" \
            + "\n")
